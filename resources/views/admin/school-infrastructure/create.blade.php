...
@section('title', 'Admin Panel - Add School Infrastructure')
        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.school-infrastructure.create') }}">Add School Infrastructure</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Add School Infrastructure</div>
                        </div>
                        <form method="POST" action="{{ route('admin.school-infrastructure.store') }}" id="schoolInfrastructureForm">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
