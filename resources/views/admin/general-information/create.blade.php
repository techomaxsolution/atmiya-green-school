...
@section('title', 'Admin Panel - Add General Information')
        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs mb-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.general-information.create') }}">Add General Information</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Add General Information</div>
                        </div>
                        <form method="POST" action="{{ route('admin.general-information.store') }}" id="generalInformationForm">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
