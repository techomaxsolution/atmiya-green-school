...
@section('title', 'Admin Panel - Document Information')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('admin.document-information.create') }}" class=" float-end btn btn-sm btn-rounded btn-primary">
                                ...
                                <table id="basic-datatables" class="display table table-striped table-hover">
                                    ...
                                    @forelse($documentInformation as $value)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.document-information.edit', $value->id) }}" class="btn btn-lg btn-link btn-primary">
...
@section('footer-script')
    ...
    <script type="text/javascript">
        function deletetestimonial_info(id) {
            let url = '{{ route('admin.document-information.delete', 'id') }}'.replace('id', id);
